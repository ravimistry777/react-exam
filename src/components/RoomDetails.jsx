  ...
  return (
    <div className="card-hover h-100 border border-light rounded-0 bg-white d-flex flex-column transition-all">
      ...
      <div className="p-4 d-flex flex-column flex-grow-1">
        ...
        <div className="mb-4">
          <div className="d-flex flex-wrap gap-3 text-secondary small mb-3 letter-spacing-1">
            <div className="d-flex align-items-center">
              <FaUsers className="me-2 opacity-75" size={13} />
              <span>{room.capacity} Guests</span>
            </div>
            <div className="d-flex align-items-center">
              <FaBed className="me-2 opacity-75" size={13} />
              <span>King Bed</span>
            </div>
          </div>
          ...
          <div className="d-flex flex-wrap gap-2">
            {room.amenities?.slice(0, 3).map((amenity, index) => (
              <span key={index} className="badge bg-light text-secondary fw-normal border border-light px-2 py-2 rounded-0 letter-spacing-1" style={{ fontSize: '0.65rem' }}>
